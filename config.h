...
//const char * STARTUP_MELODY = "";
//const char * STICK_MOVE_WARNING ="";
#endif
//----- Voltage monitoring -------------------------
...
//#define HEADTRACKER // Receive inverted SBUS on pin D7 from a headtracking module (such as a flight controller!)
// ------------------ Head tracker input config -------------------------
// HT/SBUS Channels ROLL PITCH YAW THROTTLE will override AILERON, ELEVATOR, RUDDER and THROTTLE respectively, unless commented out here
//#define USE_HT_ROLL
#define USE_HT_PITCH
#define USE_HT_YAW
